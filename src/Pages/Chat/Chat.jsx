      ...
      <div className="m-5 px-5">
        ...
        <div className="d-flex justify-content-between">
          ...
          <div className="image me-3">
            <img src="https://res.cloudinary.com/dvehyvk3d/image/upload/v1629690899/tiketing/Group_261_dwyfxr.png" alt="" />
          </div>
          <div className="chat">
          ...
          <div className="time">
            ...
            <i class="bi bi-check2-all text-blue"></i>
          </div>
        </div>
        <hr />
        <div className="d-flex justify-content-between">
          <div className="d-flex">
          <div className="image me-3">
            <img src="https://res.cloudinary.com/dvehyvk3d/image/upload/v1629690899/tiketing/Group_782_ctxtw2.png" alt="" />
          </div>
          <div className="chat">
        ...
        <div className="d-flex justify-content-between">
          <div className="d-flex">
          <div className="image me-3">
            <img src="https://res.cloudinary.com/dvehyvk3d/image/upload/v1629690899/tiketing/Group_303_fscp73.png" alt="" />
          </div>
          <div className="chat">
            <h5 className="card-title">Milky Choco</h5>
            <p className="card-text text-secondary">Me: Yes, of course come, ... </p>
          </div>
          </div>
          <div className="time">
        ...
        <div className="d-flex justify-content-between">
          <div className="d-flex">
          <div className="image me-3">
            <img src="https://res.cloudinary.com/dvehyvk3d/image/upload/v1629690899/tiketing/Group_262_hjmthw.png" alt="" />
          </div>
          <div className="chat">
            <h5 className="card-title">Calvin Flores</h5>
            <p className="card-text text-blue">Hi, bro! Come to my house!</p>
          </div>
          </div>
          <div className="time">
        ...
        <div className="d-flex justify-content-between">
          <div className="d-flex">
          <div className="image me-3">
            <img src="https://res.cloudinary.com/dvehyvk3d/image/upload/v1629690899/tiketing/Group_304_masyor.png" alt="" />
          </div>
          <div className="chat">
